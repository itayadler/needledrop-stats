@send external arrayBuffer: Fetch.Response.t => promise<Js_typed_array2.array_buffer> = "arrayBuffer"
...
module SQL = {
	...
	let makeDatabase: (t, Js.TypedArray2.Uint8Array.t) => Database.t = %raw(`function(sql, buf){ return new sql.Database(buf) }`)
}
type config = {
